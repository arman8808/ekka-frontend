    ...
    <div className="bg-white px-4 sm:px-6 lg:px-12 py-22">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-12">
        <img
          ...
          alt="Abhishek Kapadia"
          className="w-full max-w-[431px] h-auto md:h-[428px] object-contain shadow-lg order-1 md:order-1"
        />

        <div className="flex-1 text-[#5E3D8A] order-2 md:order-2">
          {" "}
          <h2 className="text-xl sm:text-2xl leading-[24px] font-medium text-[#6E2D79] font-poppins mb-2">
            Dr. Aiyasawmy, M.D.
          </h2>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-12">
        ...
        <div className="flex-1 text-[#5E3D8A] order-2 md:order-1">
          <h2 className="text-xl sm:text-2xl leading-[24px] font-medium text-[#6E2D79] font-poppins mb-2">
            Dr. Rupa Mahadevan, M.D.
          </h2>
          <p className="text-base sm:text-lg leading-[30px] text-[#A35F93] font-normal">
            Dr. Rupa Mahadevan is a board-certified pediatrician specializing in
            integrative medicine. She is deeply committed to helping children
            reach their fullest potential by incorporating a variety of holistic
            modalities into her practice. Her approach focuses on mind-body
            medicine and culinary medicine, grounded in the belief that the body
            has an innate ability to heal itself when supported by a healthy
            lifestyle, nutritious food, restorative sleep, and nurturing
            relationships.
          </p>
        </div>
      ...
      <div className="flex flex-col md:flex-row-reverse justify-between items-center gap-10 mt-12">
        <img
