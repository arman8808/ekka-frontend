...
const contactSchema = yup.object({
  ...
  country: yup.string().required('Country is required').notOneOf([''], 'Country is required'),
  zipCode: yup.string().required('Zip code is required').min(3, 'Must be at least 3 characters'),
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <motion.div variants={ANIMATION_CONFIG.fadeInUp} className="pt-2">
                <div className="flex items-start">
                  ...
                  />
                  <label htmlFor="acceptPrivacyPolicy" className="ml-3 text-sm text-[#6E2D79]">
                    I accept the{' '}
                    <motion.a
                      href="/privacy-policy"
                      target="_blank"
                ...
                <motion.button
                  ...
                  whileHover={
                    !isSubmitting && isDirty && isValid
                      ? { scale: 1.02, boxShadow: '0 20px 40px rgba(110,45,121,0.3)' }
                      : {}
                  }
                  whileTap={!isSubmitting && isDirty && isValid ? { scale: 0.98 } : {}}
                  className={`
